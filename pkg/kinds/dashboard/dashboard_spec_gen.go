...
// SpecPanels0 defines model for Spec.Panels.0.
type SpecPanels0 struct {
	// Sets panel queries cache timeout.
	CacheTimeout *string `json:"cacheTimeout,omitempty"`
	...
	// Direction to repeat in if 'repeat' is set.
	// `h` for horizontal, `v` for vertical.
	RepeatDirection *SpecPanels0RepeatDirection `json:"repeatDirection,omitempty"`
...
// VariableModelQuery0 defines model for VariableModel.Query.0.
type VariableModelQuery0 = string

// VariableModelQuery1 defines model for VariableModel.Query.1.
type VariableModelQuery1 = map[string]any
...
// VariableOptionText0 defines model for VariableOption.Text.0.
type VariableOptionText0 = string

// VariableOptionText1 defines model for VariableOption.Text.1.
type VariableOptionText1 = []string

// VariableOptionValue0 defines model for VariableOption.Value.0.
type VariableOptionValue0 = string

// VariableOptionValue1 defines model for VariableOption.Value.1.
type VariableOptionValue1 = []string
