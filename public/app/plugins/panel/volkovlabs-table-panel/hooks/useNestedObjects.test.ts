...
import { CellType } from 'app/plugins/panel/volkovlabs-table-panel/types';
import { createColumnConfig, createNestedObjectConfig, createNestedObjectEditorConfig } from 'app/plugins/panel/volkovlabs-table-panel/utils';
