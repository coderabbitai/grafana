...
import { ColumnConfig, NestedObjectConfig } from 'app/plugins/panel/volkovlabs-table-panel/types';
import { prepareFrameForNestedObject } from 'app/plugins/panel/volkovlabs-table-panel/utils';
