...
import { PaginationMode } from 'app/plugins/panel/volkovlabs-table-panel/types';
import { createTablePaginationConfig } from 'app/plugins/panel/volkovlabs-table-panel/utils';
