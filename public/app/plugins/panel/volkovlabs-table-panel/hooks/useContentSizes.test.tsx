...
import { RowHighlightConfig, ScrollToRowPosition } from 'app/plugins/panel/volkovlabs-table-panel/types';
import { createRowHighlightConfig, createToolbarOptions } from 'app/plugins/panel/volkovlabs-table-panel/utils';
