...
import { PAGE_SIZES } from 'app/plugins/panel/volkovlabs-table-panel/constants';
import { Pagination, PaginationMode, TablePaginationConfig, ValueOrUpdater } from 'app/plugins/panel/volkovlabs-table-panel/types';
import { getFieldBySource, getVariableKeyForLocation, getVariableNumberValue, setVariablesValue } from 'app/plugins/panel/volkovlabs-table-panel/utils';
