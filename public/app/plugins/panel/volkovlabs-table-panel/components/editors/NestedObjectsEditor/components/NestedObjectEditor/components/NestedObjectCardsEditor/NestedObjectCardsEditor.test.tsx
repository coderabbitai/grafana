...
import { NestedObjectCardsDisplay, NestedObjectType } from 'app/plugins/panel/volkovlabs-table-panel/types';
import { createNestedObjectEditorConfig } from 'app/plugins/panel/volkovlabs-table-panel/utils';
