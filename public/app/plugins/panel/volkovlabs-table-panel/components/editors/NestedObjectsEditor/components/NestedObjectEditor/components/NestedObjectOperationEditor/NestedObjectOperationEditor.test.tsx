...
import { PermissionMode } from 'app/plugins/panel/volkovlabs-table-panel/types';
import { createNestedObjectOperationConfig, createPermissionConfig, createTableRequestConfig } from 'app/plugins/panel/volkovlabs-table-panel/utils';
