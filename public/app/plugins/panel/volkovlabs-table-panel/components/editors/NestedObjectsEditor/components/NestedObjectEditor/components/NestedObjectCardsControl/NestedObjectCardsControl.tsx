...
import { useDashboardRefresh, useDatasourceRequest } from 'app/plugins/panel/volkovlabs-table-panel/components/VolkovComponents';
...
import { NestedObjectCardsDisplay, NestedObjectControlProps, NestedObjectItemPayload, NestedObjectType } from 'app/plugins/panel/volkovlabs-table-panel/types';
