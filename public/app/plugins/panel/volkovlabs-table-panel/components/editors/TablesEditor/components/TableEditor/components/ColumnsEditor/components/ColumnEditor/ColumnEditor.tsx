...
import { NumberInput, Slider } from 'app/plugins/panel/volkovlabs-table-panel/components/VolkovComponents';
import React, { useMemo, useState } from 'react';

import { FieldsGroup } from 'app/plugins/panel/volkovlabs-table-panel/components';
import { ColorEditor, FieldPicker } from 'app/plugins/panel/volkovlabs-table-panel/components/editors';
import { DEFAULT_SHOWING_ROWS, GAUGE_DEFAULT_VALUE_SIZE, TEST_IDS } from 'app/plugins/panel/volkovlabs-table-panel/constants';
import { tablesEditorContext } from 'app/plugins/panel/volkovlabs-table-panel/hooks';
import {
  CellAggregation,
  CellType,
  ColumnAlignment,
