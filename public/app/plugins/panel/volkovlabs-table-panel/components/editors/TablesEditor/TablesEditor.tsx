...
import { DEFAULT_PERMISSION_CONFIG, DEFAULT_REQUEST_CONFIG, PAGE_SIZES, TEST_IDS } from 'app/plugins/panel/volkovlabs-table-panel/constants';
...
import { reorder } from 'app/plugins/panel/volkovlabs-table-panel/utils';
