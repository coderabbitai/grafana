...
import { ColumnAlignment, ColumnHeaderFontSize } from 'app/plugins/panel/volkovlabs-table-panel/types';
import { createActionsColumnConfig } from 'app/plugins/panel/volkovlabs-table-panel/utils';
