...
import { DEFAULT_COLUMN_APPEARANCE, TEST_IDS } from 'app/plugins/panel/volkovlabs-table-panel/constants';
import { ColumnPinDirection } from 'app/plugins/panel/volkovlabs-table-panel/types';
import {
