...
import { CollapseTitle, FieldPicker } from 'app/plugins/panel/volkovlabs-table-panel/components';
import {
...
import { getFieldKey, reorder } from 'app/plugins/panel/volkovlabs-table-panel/utils';
