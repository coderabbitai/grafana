...
import { EditorProps, PermissionConfig, PermissionMode } from 'app/plugins/panel/volkovlabs-table-panel/types';
import { cleanPayloadObject } from 'app/plugins/panel/volkovlabs-table-panel/utils';
