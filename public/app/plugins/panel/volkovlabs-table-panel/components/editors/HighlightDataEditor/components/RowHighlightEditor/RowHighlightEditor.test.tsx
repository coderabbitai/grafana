...
import { ScrollToRowPosition } from 'app/plugins/panel/volkovlabs-table-panel/types';
import { createColumnConfig, createRowHighlightConfig, createVariable } from 'app/plugins/panel/volkovlabs-table-panel/utils';
