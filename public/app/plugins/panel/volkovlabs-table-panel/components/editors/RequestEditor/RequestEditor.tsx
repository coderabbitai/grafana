...
import { DatasourceEditor, DatasourcePayloadEditor } from 'app/plugins/panel/volkovlabs-table-panel/components';
import { EditorProps, TableRequestConfig } from 'app/plugins/panel/volkovlabs-table-panel/types';
