...
import { ColumnEditorConfig, ColumnEditorType, EditorProps } from 'app/plugins/panel/volkovlabs-table-panel/types';
import { getColumnEditorConfig } from 'app/plugins/panel/volkovlabs-table-panel/utils';
