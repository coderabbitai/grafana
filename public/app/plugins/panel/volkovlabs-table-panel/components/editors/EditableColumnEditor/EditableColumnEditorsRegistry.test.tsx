...
import { ColumnEditorConfig, ColumnEditorType } from 'app/plugins/panel/volkovlabs-table-panel/types';
import { createColumnEditConfig, toBase64 } from 'app/plugins/panel/volkovlabs-table-panel/utils';
