...
import { ColumnEditorType } from 'app/plugins/panel/volkovlabs-table-panel/types';
import { createColumnMeta } from 'app/plugins/panel/volkovlabs-table-panel/utils';
