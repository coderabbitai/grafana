...
import { nestedObjectEditorsRegistry } from 'app/plugins/panel/volkovlabs-table-panel/components';
import { ACTIONS_COLUMN_ID, TEST_IDS } from 'app/plugins/panel/volkovlabs-table-panel/constants';
import { CellAggregation, CellType } from 'app/plugins/panel/volkovlabs-table-panel/types';
