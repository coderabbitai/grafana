...
import { ColumnConfig, SupportedFileType } from 'app/plugins/panel/volkovlabs-table-panel/types';
import { getFieldBySource, getValueIndex, handleMediaData } from 'app/plugins/panel/volkovlabs-table-panel/utils';
