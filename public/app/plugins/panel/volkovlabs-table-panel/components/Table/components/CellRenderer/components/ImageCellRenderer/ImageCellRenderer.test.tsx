...
import { ColumnMeta, ImageScale } from 'app/plugins/panel/volkovlabs-table-panel/types';
import { createColumnConfig } from 'app/plugins/panel/volkovlabs-table-panel/utils';

import { ImageCellRenderer } from './ImageCellRenderer';

type Props = React.ComponentProps<typeof ImageCellRenderer>;

describe('ImageCellRenderer', () => {
  /**
   * Selectors
   */
  const getSelectors = getJestSelectors(TEST_IDS.imageCellRenderer);
  ...
  const getComponent = (props: Partial<Props>) => {
    return <ImageCellRenderer {...(props as any)} />;
  };
