...
import { BASE64_MEDIA_HEADER_REGEX, MEDIA_TYPES_SYMBOLS } from 'app/plugins/panel/volkovlabs-table-panel/constants';
import { SupportedFileType } from 'app/plugins/panel/volkovlabs-table-panel/types';
